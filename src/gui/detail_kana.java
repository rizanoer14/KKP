...
public class detail_kana extends javax.swing.JFrame {
private Connection conn = new konek().connect();
  ...
  protected void tampil(){
    ...
    private void initComponents() {
        ...
        kana1 = new javax.swing.JRadioButton();
        kana2 = new javax.swing.JRadioButton();
        ...
        kana1.setBackground(new java.awt.Color(255, 255, 255));
        pilih.add(kana1);
        kana1.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        kana1.setText("KANA I");
        kana1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        kana1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kana1ActionPerformed(evt);
            }
        });

        kana2.setBackground(new java.awt.Color(255, 255, 255));
        pilih.add(kana2);
        kana2.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        kana2.setText("KANA II");
        kana2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        kana2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kana2ActionPerformed(evt);
            }
        });
        ...
        jTextArea3.setText("Harga Paket    : Rp 440.000,- \nDeskripsi Paket: ");
        ...
        jTextArea4.setText("Harga Paket    : Rp 440.000,- \nDeskripsi Paket: ");
    ...
    private void kana1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kana1ActionPerformed
        x=1;
    }//GEN-LAST:event_kana1ActionPerformed

    private void kana2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kana2ActionPerformed
        x=2;
    }//GEN-LAST:event_kana2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detail_kana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detail_kana().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JRadioButton kana1;
    private javax.swing.JRadioButton kana2;
