...
public class detail_nusa extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("NUSA INDAH (S. TENIS)");

        jTextArea2.setColumns(20);
        jTextArea2.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        jTextArea2.setRows(5);
        jTextArea2.setText("Harga Paket    : Rp 440.000,- \nDeskripsi Paket: \n");
        ...
        jLabel5.setText("Nusa Indah (S. Tenis)");
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detail_nusa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detail_nusa().setVisible(true);
            }
        });
    }
