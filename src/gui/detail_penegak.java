...
public class detail_penegak extends javax.swing.JFrame {
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detail_penegak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detail_penegak().setVisible(true);
            }
        });
    }
