...
public class detail_penggalang extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("SAUNG PENGGALANG");
        ...
        jLabel5.setText("Saung Penggalang");
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detail_penggalang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detail_penggalang().setVisible(true);
            }
        });
    }
