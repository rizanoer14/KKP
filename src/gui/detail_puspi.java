 ...
 * @author Available
 */
public class detail_puspi extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detail_puspi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detail_puspi().setVisible(true);
            }
        });
    }
