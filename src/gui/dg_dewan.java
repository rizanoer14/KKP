...
public class dg_dewan extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("KI HAJAR DEWANTORO");
        ...
        image.setText("Ki Hajar Dewantoro");
    ...
    private void imageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageMouseClicked
        slider_dewan n = new slider_dewan();
        n.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dg_dewan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
