...
public class dg_mawar extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
       //slider_mawar n = new slider_mawar();
       // n.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dg_mawar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
