...
public class dg_puspi extends javax.swing.JFrame { 
...
protected void tampil(){
    ...
    private void imageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageMouseClicked
       // slider_puspi n = new slider_puspi();
       // n.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dg_puspi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
