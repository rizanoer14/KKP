...
public class dg_sarbini extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("SARBINI");

        jTextArea2.setColumns(20);
        jTextArea2.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        jTextArea2.setRows(5);
        jTextArea2.setText("Harga Paket    : Rp 9.350.000,- \nDeskripsi Paket: \n1. Kapasitas 200 kursi\n2. Sound System\n3. AC");
        jTextArea2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane2.setViewportView(jTextArea2);

        sarbini.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        sarbini.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/dewan.jpg"))); // NOI18N
    ...
    private void sarbiniMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sarbiniMouseClicked
        //slider_sarbini n = new slider_sarbini();
        //n.setVisible(true);
    }//GEN-LAST:event_sarbiniMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dg_sarbini.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dg_sarbini().setVisible(true);
            }
        });
    }
