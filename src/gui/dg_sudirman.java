...
public class dg_sudirman extends javax.swing.JFrame {
 private Connection conn = new konek().connect();
  ...
  protected void tampil(){
    ...
    private void initComponents() {
        ...
        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/sudirman.jpg"))); // NOI18N
        image.setText("Sudirman");
    ...
    private void imageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageMouseClicked
        slider_sudir n = new slider_sudir();
        n.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dg_sudirman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dg_sudirman().setVisible(true);
            }
        });
    }
