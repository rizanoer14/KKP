...
public class dp_kamar extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void initComponents() {
        ...
        jTextArea2.setText("Harga Paket    : Rp 330.000,- / malam / wisma\nDeskripsi Paket: \n1. 2 Tempat Tidur AC\n2. TV\n3. Water Heater\n");
    ...
    private void imageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageMouseClicked
       // slider_pkamar n = new slider_pkamar();
       // n.setVisible(true);
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dp_kamar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
