...
public class dp_kenanga extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void imageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageMouseClicked
       // slider_pkenanga n = new slider_pkenanga();
       // n.setVisible(true);
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dp_kenanga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dp_kenanga().setVisible(true);
            }
        });
    }
