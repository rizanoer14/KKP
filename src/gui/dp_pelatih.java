...
public class dp_pelatih extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("WISMA PELATIH");

        jTextArea2.setColumns(20);
        jTextArea2.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        jTextArea2.setRows(5);
        jTextArea2.setText("Harga Paket    : Rp 1.320.000,- / malam / kamar\nDeskripsi Paket: \n1. Kapasitas 19 Orang");
    ...
    private void imageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageMouseClicked
       // slider_ppelatih n = new slider_ppelatih();
       // n.setVisible(true);
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dp_pelatih.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dp_pelatih().setVisible(true);
            }
        });
    }
