...
public class dp_purbo1 extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void imageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageMouseClicked
       // slider_ppurbo1 n = new slider_ppurbo1();
       // n.setVisible(true);
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dp_purbo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
