...
public class dp_smalam extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("WISMA SEDAP MALAM");

        jTextArea2.setColumns(20);
        jTextArea2.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        jTextArea2.setRows(5);
        jTextArea2.setText("Harga Paket    : Rp 220.000,- / malam / kamar\nDeskripsi Paket: \n");
        ...
        image.setText("Wisma Sedap Malam");
    ...
    private void imageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageMouseClicked
       // slider_psmalam n = new slider_psmalam();
       // n.setVisible(true);
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dp_smalam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
