...
public class dp_wisma extends javax.swing.JFrame {
  ...
  public dp_wisma() {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("WISMA");

        jTextArea2.setColumns(20);
        jTextArea2.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        jTextArea2.setRows(5);
        jTextArea2.setText("Harga Paket    : Rp 1.320.000,- / malam / wisma\nDeskripsi Paket: \n1. 4 Kamar AC\n2. 2 Tempat Tidur\n3. Water Heater");
    ...
    private void imageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageMouseClicked
       // slider_pwisma n = new slider_pwisma();
       // n.setVisible(true);
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dp_wisma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
