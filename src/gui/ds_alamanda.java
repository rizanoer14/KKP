...
public class ds_alamanda extends javax.swing.JFrame {
 ...
 */
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ds_alamanda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ds_alamanda().setVisible(true);
            }
        });
    }
