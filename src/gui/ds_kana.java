...
public class ds_kana extends javax.swing.JFrame {
  ...
  protected void tampil(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ds_kana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
