...
public class ds_tunas extends javax.swing.JFrame {
  ...
  public ds_tunas() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ds_tunas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
