...
public class periode_saung extends javax.swing.JFrame {
    private Connection conn = new konek().connect();
    public periode_saung() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Periode Cetak Laporan Penyewaan Saung");
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
       ...
       //   File f = new File("D:/KKP/wildat/src/laporan/Laporan.jrxml");
            File f = new File("C:\\Users\\Hp\\Documents\\NetBeansProjects\\KKP\\KKP\\src\\laporan\\keuangan_saung.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(periode_saung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new periode_saung().setVisible(true);
            }
        });
    }
