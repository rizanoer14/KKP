...
public class pk_sarbini extends javax.swing.JFrame {
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
       ...
       //   File f = new File("D:/KKP/wildat/src/laporan/Laporan.jrxml");
            File f = new File("C:\\Users\\Hp\\Documents\\NetBeansProjects\\KKP\\KKP\\src\\laporan\\KSarbini.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pk_sarbini.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pk_sarbini().setVisible(true);
            }
        });
    }
