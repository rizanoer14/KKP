...
public class psewa_gedung extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Periode Cetak Laporan Penyewaan Ruang Diklat");
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
       ...
       //   File f = new File("D:/KKP/wildat/src/laporan/Laporan.jrxml");
            File f = new File("C:\\Users\\Hp\\Documents\\NetBeansProjects\\KKP\\KKP\\src\\laporan\\sewa_gedung.jrxml");
            ...
            jv.setTitle("Laporan Penyewaan Gedung Pertemuan");
            jv.setVisible(true);
            dispose();
        }
        catch(Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(psewa_gedung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new psewa_gedung().setVisible(true);
            }
        });
    }
