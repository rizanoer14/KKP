...
public class psewa_saung extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Periode Cetak Laporan Penyewaan Fasilitas Taman(Saung)");
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
       ...
       //   File f = new File("D:/KKP/wildat/src/laporan/Laporan.jrxml");
            File f = new File("C:\\Users\\Hp\\Documents\\NetBeansProjects\\KKP\\KKP\\src\\laporan\\sewa_saung.jrxml");
            ...
            jv.setTitle("Laporan Penyewaan Gedung Saung");
            jv.setVisible(true);
            dispose();
        }
        catch(Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(psewa_saung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new psewa_saung().setVisible(true);
            }
        });
    }
