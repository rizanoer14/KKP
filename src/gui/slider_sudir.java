...
public class slider_sudir extends javax.swing.JFrame {
...
{
    File f=new File(getClass().getResource("/image_sudirman").getFile());
...
public void show(int index)
{
    ...
    ImageIcon icon=new ImageIcon(getClass().getResource("/image_sudirman/"+img));
    ...
    private void nextMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nextMousePressed
      new Thread();
        try {
            ...
            Logger.getLogger(slider_sudir.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(slider_sudir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new slider_sudir().setVisible(true);
            }
        });
    }
